...
const { ChatManager, TokenProvider } = require("@pusher/chatkit"); // chatkit client SDK
const axios = require("axios");
const prompt = require("prompt"); // command-line prompt for node.js
const ora = require("ora");

// trick chatkit into thinking its working on the broswer for node.js
